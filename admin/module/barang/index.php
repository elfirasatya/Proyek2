              ...
              <div class="row">
                  <div class="col-lg-12 main-chart">
						...
						<!-- <a href="index.php?page=barang&stok=yes" style="margin-right :0.5pc;" 
							...
							<i class="fa fa-list"></i> Sortir Basket Kurang</a> -->
					...
					<!-- tambah barang MODALS-->
						...
						<div id="myModal" class="modal fade" role="dialog">
							<div class="modal-dialog">
								...
								<div class="modal-header" style="background:#6B7AA1;color:#fff;">
								...
								<form action="fungsi/tambah/tambah.php?barang=tambah" method="POST">
									<div class="modal-body">
										...
										<table class="table table-striped bordered">
											...
											<tr>
												<td>Berat Barang</td>
												<td><input type="text" placeholder="berat Barang" required class="form-control"  name="berat"></td>
											</tr>
											<tr>
												<td>Harga Beli</td>
											...
											<tr>
												<td>Basket</td>
												<td><input type="number" required Placeholder="Basket" class="form-control"  name="stok"></td>
											</tr>
											<tr>
												<td>Tanggal Input</td>
